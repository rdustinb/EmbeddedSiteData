...
function drawSensorWidget(_ctx,_Sensor,_widgetWidth,_widgetHeight,_type){
  ...
  drawSmoothSamplesGraphRange(_ctx,_Sensor,_widgetWidth,_widgetHeight,_type);
  drawSmoothSamplesGraph(_ctx,_Sensor,_widgetWidth,_widgetHeight,_type);
...
function drawSamplesGraphBox(_ctx,_widgetWidth,_widgetHeight){
  ...
  var _point2y = CyOffset+_widgetHeight-1; // Line thickness is 2 so we offset by 1
  var _point3x = CxOffset+_widgetWidth;
  var _point3y = CyOffset+_widgetHeight-1; // Line thickness is 2 so we offset by 1
...
function drawSmoothSamplesGraphRange(_ctx,_Sensor,_widgetWidth,_widgetHeight,_type){
  // Draw Data Samples
  var _sampleWidth = _widgetWidth / (_Sensor.length+1);
  var _sampleMin =  10000;
  var _sampleMax = -10000;
...
function drawSmoothSamplesGraph(_ctx,_Sensor,_widgetWidth,_widgetHeight,_type){
  // Draw Data Samples
  var _sampleWidth = _widgetWidth / (_Sensor.length+1);
  var _sampleMin =  10000;
  var _sampleMax = -10000;
